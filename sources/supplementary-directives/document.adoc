...
:copyright-year: 2021
:language: en
:title-main-en: Rules for the structure and drafting of SC 4 standards for industrial data
:title-main-fr: Règles pour la structure et la rédaction des normes SC 4 pour les données industrielles
:doctype: guide
:docstage: 60
:docsubstage: 60
...
* [[[isodir2,ISO/IEC DIR 2 ISO]]], _Principles and rules for the structure and drafting of ISO and IEC documents_

* [[[isodir1,ISO/IEC DIR 1 ISO SUP]]], _Procedures specific to ISO The ISO Simple template_ footnote:f2[available at https://isotc.iso.org/livelink/livelink/properties/17851245]
